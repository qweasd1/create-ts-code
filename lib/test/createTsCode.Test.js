...
it('create simple code', function () {
    const code = createTsCode_1.file(({ $from, $let, $const, $public, $protected, $private, $static, $abstract, $field, $export, $line, $class, $interface, $enum, $ref, $invoke, $invoke_, $method, $get, $set, $function, $arrow, $constructor, $annotation, $function_, $arrow_, $array_, $obj_ }) => {
...
it('angular component', function () {
    ...
    console.log(createTsCode_1.file(({ $class, $annotation, $method, $from, $line, $constructor, $field, $array_, $let }) => {
        const isInit = true;
